...
echo_and_run cd "/home/caft-yasiru/arm/src/rosserial/rosserial_python"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/caft-yasiru/arm/src/rosserial/rosserial_python/setup.py" \
     \
    build --build-base "/home/caft-yasiru/arm/build/rosserial/rosserial_python" \
    install \
    --root="${DESTDIR-/}" \
