...
echo_and_run cd "/home/caft-yasiru/arm/src/rosserial/rosserial_arduino"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/caft-yasiru/arm/src/rosserial/rosserial_arduino/setup.py" \
     \
    build --build-base "/home/caft-yasiru/arm/build/rosserial/rosserial_arduino" \
    install \
    --root="${DESTDIR-/}" \
