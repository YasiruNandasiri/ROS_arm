...
echo_and_run cd "/home/caft-yasiru/arm/src/rosserial/rosserial_vex_cortex"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/caft-yasiru/arm/src/rosserial/rosserial_vex_cortex/setup.py" \
     \
    build --build-base "/home/caft-yasiru/arm/build/rosserial/rosserial_vex_cortex" \
    install \
    --root="${DESTDIR-/}" \
