...
echo_and_run cd "/home/caft-yasiru/arm/src/rosserial/rosserial_xbee"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/caft-yasiru/arm/src/rosserial/rosserial_xbee/setup.py" \
     \
    build --build-base "/home/caft-yasiru/arm/build/rosserial/rosserial_xbee" \
    install \
    --root="${DESTDIR-/}" \
